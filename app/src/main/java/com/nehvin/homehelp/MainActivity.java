...
//                Intent dataToShow = new Intent(getApplicationContext(), );
                break;
            case 1:
...
// electrical list
        electricalList.add(new ServiceView("Gala Electrical", "GSTN1234",
                ...
                "comment 2, comment 3", "abcl@abcl.com", "1234567890", "abc.com"));
        electricalList.add(new ServiceView("Sidhi Electrical", "7890ABCL",
                ...
                "good, excellent service, nice", "abcl@abcl.com", "1234567890", "abc.com"));
        electricalList.add(new ServiceView("Vineet Handyman", null,
                ...
                "fairly newly started service", "abcl@abcl.com", "1234567890", "abc.com"));
...
// car list
        carList.add(new ServiceView("Harpreet Singh Auto Services", "GT521QWE",
                ...
                "on request", "3.5",
                "takes good car of the car, no issues after service, good work", "abcl@abcl.com", "1234567890", "abc.com"));
        carList.add(new ServiceView("Sai Auto Services", "LJDS9274LJD",
                ...
                "after service, good work", "abcl@abcl.com", "1234567890", "abc.com"));
...
// home list
        homeList.add(new ServiceView("Shreeji Home Services", "OIWEU9872UZ",
                ...
                "comment 1, comment 2, comment 3", "abcl@abcl.com", "1234567890", "abc.com"));
        homeList.add(new ServiceView("Mamta Home Cleaning", "OIWEU9872UZ",
                "Specialist in home cleaning and window cleaning from the inside and outside , " ,
                         "$25/hr", "3", "comment 1, comment 2, comment 3", "abcl@abcl.com", "1234567890", "abc.com"));
        homeList.add(new ServiceView("Climate Cool Services", "OIWEU9872UZ",
                "Air conditioner services, " +
                        "Split as well as window or ceiling AC",
                "$10/hr", "3", "comment 1, comment 2, comment 3", "abcl@abcl.com", "1234567890", "abc.com"));
